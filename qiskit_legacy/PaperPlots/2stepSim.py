...
############################################################################################################
    ...
    qc2.add_register(cp2)
    qc2.add_register(ch1)
    qc2.add_register(ch2)
    qc2.add_register(ce)
    qc2.add_register(cphi)
    qc2.add_register(ca)
    qc2.add_register(cb)
...
if __name__ == "__main__":
    ...
    countsb={}
    counts2b={}
    if (True): #for plotting, save time and don't rerun the quantum simulation every time.
        counts2 = runQuantum(0,1)
        myfile = open("hold_0.txt","w")
        for c in counts2:
            myfile.write(c+" "+str(counts2[c])+"\n")
            pass
        ...
        for c in counts:
            ...
            pass
        counts2b = runQuantum(0,0)
        myfile = open("hold_0b.txt","w")
        for c in counts2b:
            myfile.write(c+" "+str(counts2b[c])+"\n")
            pass
        countsb = runQuantum(1,0)
        myfile = open("hold_1b.txt","w")
        for c in countsb:
            myfile.write(c+" "+str(countsb[c])+"\n")
            pass
        pass
    else:
